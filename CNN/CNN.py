...
# from Structures.cnn_structure5 import *
# from Structures.cnn_structure6 import *
from Structures.cnn_structure6_2 import *
...
class CNN:
    ...
    def create_L_Sizes(self,image_size):
        ...
        L8_out_size = L7_out_size
        # L7_out_size = [int(numpy.floor(float(L6_out_size[0] - L7_k[0] + 1) / 2)),
        #                int(numpy.floor(float(L6_out_size[1] - L7_k[1] + 1) / 2))]
        L9_out_size = [int(numpy.floor(float(L8_out_size[0] - L9_k[0] + 1) / 2)),
         int(numpy.floor(float(L8_out_size[1] - L9_k[1] + 1) / 2))]
        # print L0_out_size
        # print L1_out_size
        # print L2_out_size
        # print L3_out_size
        ...
        return [L0_out_size, L1_out_size, L2_out_size, L3_out_size, L4_out_size, L5_out_size, L6_out_size, L7_out_size, L8_out_size, L9_out_size] #
