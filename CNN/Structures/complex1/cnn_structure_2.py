...
class CNN_struct_comp2(object):
    ...
    def get_intermediate_sides(self):
        return  self.bloc7_1.output, self.sofmax_input,  #, self.predictor.p_y_given_x


    def struct_tester(self):
        return self.bloc8.output