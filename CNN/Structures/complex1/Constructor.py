...
class ConvLayer(object):
    ...
    def __init__(self, rng, input, image_shape, filter_shape, subsample=(1,1), border_mode = 'valid', activ_func = 'relu'):
        """
        ...
        if activ_func == 'relu':
            ...
            self.rectified_conv_out = T.nnet.sigmoid(conv_out + self.b.dimshuffle('x', 0, 'x', 'x'))
...
class SumPoolLayer(object):
    """Sum Layer of a convolutional network """
